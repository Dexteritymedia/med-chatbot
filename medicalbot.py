        ...
        with st.spinner("Please wait..."):
            ...
            tools = [
                Tool.from_function(
                    func=pub_med.run,
                    name="PubMed",
                    description="useful for when you need to answer questions about academic papers, publications, researches, scholars, citations for biomedical literature, life science journals, and online books."
                ),
                Tool(
